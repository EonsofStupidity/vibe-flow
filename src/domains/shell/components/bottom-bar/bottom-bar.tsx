...
export function BottomBar() {
  ...
  return (
    <footer
      role="contentinfo"
      className="flex items-center justify-between gap-f3 border-t border-hairline bg-surface-raised/80 px-f4 font-mono text-eyebrow uppercase tracking-[0.2em] text-ink-muted backdrop-blur-md"
    ...
    >
      ...
      <div className="hidden gap-f3 sm:flex">
        <kbd className="rounded-f-sm bg-surface px-f2">[</kbd>
        <kbd className="rounded-f-sm bg-surface px-f2">]</kbd>
        <kbd className="rounded-f-sm bg-surface px-f2">\</kbd>
        <span>toggle rail / panel / full-bleed</span>
      </div>
    </footer>
  );
}
